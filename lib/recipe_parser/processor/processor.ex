defmodule RecipeParser.Processor do
  ...
  def analyze_image(file_path) do
  ...
  def analyze_audio(file_path) do
    response =
  ...
  def convert_video_to_audio(video_path, audio_path) do
    command =
      FFmpex.new_command()
  ...
  defp summarize_file(_file_path, _ext), do: {:ok, ""}
end
